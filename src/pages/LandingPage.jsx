      ...
      <section className="section-padding bg-muted/30">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Master the art of cooking with these professional tips from our
              expert chefs
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {cookingTips.map((tip, index) => (
              <Card
                key={index}
                className="border-0 shadow-card hover:shadow-card-hover transition-all duration-300 bg-card"
              >
      ...
      <section className="section-padding bg-background">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Celebrating our amazing community of food lovers and talented home
              chefs
            </p>
          </div>
